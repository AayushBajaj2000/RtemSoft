        ...
        <CenterScreen>
            ...
            <div className="">
                ...
                <p className="text-base mb-5 text-gray-600">
                    ...
                    Please send an email to discuss the opportunities for summer
                    positions and course projects.
                </p>
            </div>
            <section class="py-10 overflow-hidden relative z-10">
                <div class="container mx-auto">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="">
                            <div class="max-w-[600px] mb-12 lg:mb-0">
                                <h2
                                    class="
                  text-dark
                  mb-6
                  ...
                  "
                                ...
                                <p class="text-base text-body-color leading-relaxed mb-9">
                                    ...
                                    Please feel free to get in touch via the
                                    contact below, we will get back to you as
                                    soon as possible.
                                </p>
                     ...
                     "
                                    ...
                                    <div class="w-full">
                                        ...
                                        <p class="text-base text-body-color">
                                            Real-Time Embedded Software Research
                                            Lab SIRC 3340
                                        </p>
                                    </div>
                                </div>
