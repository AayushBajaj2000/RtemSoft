...
const Contact = () => {
    ...
    return (
        <CenterScreen>
            <Heading
                title={"Contact"}
                desc="Contact and Openings page."
                notRounded
            />
                ...
                <div className="">
                  ...
                  "
                    ...
                    <p className="text-base mb-5 text-gray-600">
                        We often have positions for graduate students (MASc or
                        PhD). Interested students email your resume and
                        transcripts in pdf to AKRAMUL AZIM, PHD, PENG
                    ...
                    <p className="text-base mb-5 text-gray-600">
                        ...
                        project work. Open positions may be available for
                        students who are interested in conducting research with
                        me through: <br />
                        1. MITACS Gloablink <br />
                        2. Undergraduate Research Assistantships (URA) <br />
                        3. Capstone Projects <br />
                        Please send an email to discuss the opportunities for
                        summer positions and course projects.
                    </p>
                </div>
                <section className="py-10 overflow-hidden relative z-10">
                  ...
                  "
                                    ...
                                    <p className="text-base text-body-color leading-relaxed mb-9">
                                        ...
                                        via the contact below, we will get back
                     ...
                     "
                            ...
                            <div className="flex flex-row items-center">
                                <div className="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg outline outline-offset-2 outline-1 outline-gray-200 w-[90%] mx-auto">
                                    <form>
                                        <div className="mb-6">
                                            <input
                                                type="text"
