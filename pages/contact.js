...
const Contact = () => {
  return (
    <CenterScreen>
      ...
      />
      <div className="min-h-[calc(100vh-325px)] p-2">
        <ul>
          <li>Real-Time Embedded Software Research Lab SIRC 3340 2000</li>
          <li>Simcoe Street North, Oshawa, Ontario, L1H7K4 Email:</li>
          <li>akramul.azim@uoit.ca RTEMSOFT Members Google Group Group</li>
